...
class CharacterDetailFragment : Fragment(){
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.character_detail_fragment, container, false).apply {
            findViewById<ComposeView>(R.id.compose_view).setContent {
                LoadCharacterDetailsInfo()
            }
        }
    }
    ...
    @Preview
    @Composable
    fun PreviewCharacterDetailsInfo() {
        MaterialTheme {
            LoadCharacterDetailsInfo()
        }
    }
